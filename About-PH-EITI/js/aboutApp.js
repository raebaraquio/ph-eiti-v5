...
aboutApp.config(function($routeProvider){
 	$routeProvider
        ...
        .when('/MSG-Meetings?mtgId=:meetingId',
        {
...
aboutApp.config(function($mdThemingProvider) {
...
aboutApp.service('anchorSmoothScroll', function(){
...
aboutApp.controller('returnToTopController',['$scope','$location', 'anchorSmoothScroll',
...
aboutApp.factory('homeNewsFactory',['$http',
    function($http){
