var activitiesApp = angular.module('activities',['ngRoute','ngSanitize','ngCookies','navMod','ngMaterial','utilsModule','secretariatContactMod']);
activitiesApp.config(function($routeProvider){
    ...
    {
        controller: 'ActivitiesController',
        templateUrl: 'template/view.html?v=1.02'
    })
    .otherwise({
        redirectTo:'/'
    })
...
activitiesApp.controller('menuController',['$scope','NavigationFactory','utilsService','$location','$rootScope',
